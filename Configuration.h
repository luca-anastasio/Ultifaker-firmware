...
#define STRING_CONFIG_H_AUTHOR "Luca Anastasio" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ULTIMAKER_LUCA
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "Ultimaker di Luca"
...
#define FAST_PWM_FAN
#define FAST_PWM_FAN_PRESCALER 4         // 4=122Hz
